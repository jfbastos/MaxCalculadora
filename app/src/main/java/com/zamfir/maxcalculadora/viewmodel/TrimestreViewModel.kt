...
class TrimestreViewModel(private val trimestreUseCase : TrimestreUseCase) : ViewModel() {
    ...
    fun getBonificacaoTrimestral(isCalculoParcial : Boolean, valorPrimeiroTri : String, valorSegundoTri : String, valorTerceiroTri : String, valorQuartoTri : String, valorMeta : String, dataAdmissao : String) = viewModelScope.launch {
        try{
